...
This document lists all extensions used in VS Code, organized by category.
...
| Extension | Description | Link |
|-----------|-------------|------|
| `bradlc.vscode-tailwindcss` | Tailwind CSS IntelliSense and utilities | [Marketplace](https://marketplace.visualstudio.com/items?itemName=bradlc.vscode-tailwindcss) |
| `bmewburn.vscode-intelephense-client` | PHP language server with IntelliSense | [Marketplace](https://marketplace.visualstudio.com/items?itemName=bmewburn.vscode-intelephense-client) |
...
| Extension | Description | Link |
|-----------|-------------|------|
| `mtxr.sqltools` | SQL database management and queries | [Marketplace](https://marketplace.visualstudio.com/items?itemName=mtxr.sqltools) |
...
| Extension | Description | Link |
|-----------|-------------|------|
| `yzhang.markdown-all-in-one` | Comprehensive Markdown editing tools | [Marketplace](https://marketplace.visualstudio.com/items?itemName=yzhang.markdown-all-in-one) |
...
| `tomoki1207.pdf` | PDF viewer inside the editor | [Marketplace](https://marketplace.visualstudio.com/items?itemName=tomoki1207.pdf) |

## Git & Version Control

| Extension | Description | Link |
|-----------|-------------|------|
| `eamodio.gitlens` | Enhanced Git capabilities and history visualization | [Marketplace](https://marketplace.visualstudio.com/items?itemName=eamodio.gitlens) |
...
| `foxundermoon.shell-format` | Shell script formatting | [Marketplace](https://marketplace.visualstudio.com/items?itemName=foxundermoon.shell-format) |
...
| `bruno-api-client.bruno` | Open-source API client for testing requests | [Marketplace](https://marketplace.visualstudio.com/items?itemName=bruno-api-client.bruno) |
...
- Now closely mirrors Cursor's extension set (see `cursor/extensions.md`) after syncing — differences are limited to VS Code's official Pylance/Remote-Containers and Cursor's own forks of those
...
- `bruno-api-client.bruno` covers API testing (Postman was removed)
